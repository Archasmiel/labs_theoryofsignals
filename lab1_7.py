...
# функция значения одиночого прямоугольного импульса с заданной амплитудой ampl, средней координатой mid_x и шириной width
...
with open("out.txt", "w") as f:
    f.write(str(amplitude) + ' ' + str(s_width) + ' ' + str(coord) + '\n')
